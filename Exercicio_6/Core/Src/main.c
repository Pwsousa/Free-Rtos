...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of TaskADC */
  TaskADCHandle = osThreadNew(StartDefaultTask, NULL, &TaskADC_attributes);

  /* creation of TaskCalc */
  TaskCalcHandle = osThreadNew(Task_Calc, NULL, &TaskCalc_attributes);

  /* creation of TaskSave */
  TaskSaveHandle = osThreadNew(Task_Save, NULL, &TaskSave_attributes);

  /* creation of TaskSend */
  TaskSendHandle = osThreadNew(Task_Send, NULL, &TaskSend_attributes);
...
/* USER CODE BEGIN Header_Task_Calc */
/**
* @brief Function implementing the TaskCalc thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Task_Calc */
void Task_Calc(void *argument)
{
  /* USER CODE BEGIN Task_Calc */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Task_Calc */
}

/* USER CODE BEGIN Header_Task_Save */
/**
* @brief Function implementing the TaskSave thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Task_Save */
void Task_Save(void *argument)
{
  /* USER CODE BEGIN Task_Save */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Task_Save */
}
